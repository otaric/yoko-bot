...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('manga-list')
    .setDescription('Procure um mangá por lista!')
    ...
    await request('https://graphql.anilist.co', query, variables)
      .then(data => {
        ...
        const embedErro = EmbedBuilder.from(receivedEmbed)
          .setTitle('ERRO')
          .setDescription(
            `Nenhum anime com o título ${mangaName} foi encontrado, tente reescrever o título corretamente.`
          )
        ...
        function editEmbed(e) {
          ...
          const chapters = array[e].chapters
          const chaptersAtt = chapters == null ? 'em lançamento' : chapters
